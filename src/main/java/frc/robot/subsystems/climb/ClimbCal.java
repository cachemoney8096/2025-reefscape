...
public class ClimbCal {
  public static final double CLIMBING_P = 2.8, // 2.5,
      ...
      CLIMBING_D = 0.0,
      CLIMBING_FF = 0.0;
  public static final double POSITIONING_P = 2.0,
      POSITIONING_I = 0.0,
      POSITIONING_D = 0.0,
      POSITIONING_FF = 0.0;
  ...
  public static final double CLIMB_CLIMBING_POSITION_DEGREES = 65.0 + 100.0, // 45.0 + 100, // 142, // 85 was 27.x
      CLIMB_STOWED_POSITION_DEGREES = 1.0 + 100, // 63.7
      CLIMB_CLIMBING_PREP_DEGREES =  174.0 + 100;//167.0 + 100; // 76
