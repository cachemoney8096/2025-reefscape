...
public class ClimbCal {
    ...
    public static final double CLIMB_MOTOR_MAX_VELOCITY_DEG_PER_SEC = Constants.PLACEHOLDER_DOUBLE,
        CLIMB_MOTOR_MAX_VELOCITY_DEG_PER_SEC_SQUARED = Constants.PLACEHOLDER_DOUBLE;
    ...
    public static final double CLIMB_DESIRED_POSITION_ERROR_MARGIN = Constants.PLACEHOLDER_DOUBLE;
