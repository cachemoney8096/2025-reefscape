...
public class ScoringLimelight extends SubsystemBase {
   ...
   */
  public ScoringLimelight(double pitchAngleDegrees, double heightMeters, double targetHeightMeters) {
  ...
  public double getLatencySeconds() {
    return (LimelightHelpers.getLatency_Capture(ScoringLimelightConstants.SCORING_LIMELIGHT_NAME)
            + LimelightHelpers.getLatency_Pipeline(ScoringLimelightConstants.SCORING_LIMELIGHT_NAME))
        / 1000.0;
  }
