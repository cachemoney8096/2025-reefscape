...
public class DriveSubsystem extends SubsystemBase {
  ...
  public DriveSubsystem(MatchStateUtil matchState) {
    ...
    AutoBuilder.configure(
        ...
        new RobotConfig(true, DriveConstants.MASS_KG, DriveConstants.MOI, new ModuleConfig(Units.metersToInches(DriveConstants.WHEEL_DIAMETER_METERS / 2), DriveConstants.MAX_SPEED_METERS_PER_SECOND, DriveConstants., null, null, 0), new Translation2d(0.0,0.0)),
    ...
    yawOffsetMap.put(Constants.PLACEHOLDER_DOUBLE, Constants.PLACEHOLDER_DOUBLE);
   ...
   */
  public void setOutputRobotRelativeSpeeds(ChassisSpeeds desiredChassisSpeeds, DriveFeedforwards driveFeedForwards) {
