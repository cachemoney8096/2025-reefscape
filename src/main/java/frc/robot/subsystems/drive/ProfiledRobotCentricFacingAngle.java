...
public class ProfiledRobotCentricFacingAngle implements SwerveRequest {
     ...
     * @return this object
     */
    public ProfiledRobotCentricFacingAngle withRotationalDeadband(AngularVelocity newRotationalDeadband) {
     ...
     * @return this object
     */
    public ProfiledRobotCentricFacingAngle withDriveRequestType(SwerveModule.DriveRequestType newDriveRequestType) {
     ...
     * @return this object
     */
    public ProfiledRobotCentricFacingAngle withSteerRequestType(SwerveModule.SteerRequestType newSteerRequestType) {
     ...
     * @return this object
     */
    public ProfiledRobotCentricFacingAngle withDesaturateWheelSpeeds(boolean newDesaturateWheelSpeeds) {
