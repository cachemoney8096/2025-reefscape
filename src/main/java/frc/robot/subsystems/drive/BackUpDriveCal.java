...
public class BackUpDriveCal {
  ...
  public static final double DRIVING_P = Constants.PLACEHOLDER_DOUBLE,
      ...
      DRIVING_FF = Constants.PLACEHOLDER_DOUBLE / DriveConstants.DRIVE_WHEEL_FREE_SPEED_METERS_PER_SECOND;

  /** Input radians, output [-1,1] */
  public static final double TURNING_P = Constants.PLACEHOLDER_DOUBLE, TURNING_I = Constants.PLACEHOLDER_DOUBLE, TURNING_D = Constants.PLACEHOLDER_DOUBLE, TURNING_FF = Constants.PLACEHOLDER_DOUBLE;
   ...
   */
  public static double SWERVE_FRONT_LEFT_ANGULAR_OFFSET_RAD = Constants.PLACEHOLDER_DOUBLE + Math.PI,
  ...
  public static final double
      FRONT_LEFT_CHASSIS_ANGULAR_OFFSET_RAD =
          SWERVE_FRONT_LEFT_ANGULAR_OFFSET_RAD - (Constants.PLACEHOLDER_DOUBLE * Math.PI / Constants.PLACEHOLDER_DOUBLE),
  ...
  public static final PIDController ROTATE_TO_TARGET_PID_CONTROLLER =
      new PIDController(Constants.PLACEHOLDER_DOUBLE, Constants.PLACEHOLDER_DOUBLE, Constants.PLACEHOLDER_DOUBLE);
  ...
  public static final double TURNING_ENCODER_ZEROING_THRESHOLD_RAD = Units.degreesToRadians(Constants.PLACEHOLDER_DOUBLE);
}