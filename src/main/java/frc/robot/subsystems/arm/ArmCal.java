package frc.robot.subsystems.arm;
    ...
    public class ArmCal {
  public static final double ARM_POSITION_INTAKE_DEGREES = 300.5, // 141.5 - 57,
      ARM_POSITION_HOME_DEGREES = 182.0, // 108
      ARM_POSITION_L1_DEGREES = 74.0,
      ARM_POSITION_L2_DEGREES = 74.0,
      ARM_POSITION_L3_DEGREES = 74.0, //106.0 + 42 + 13 + 17.5
    //   ARM_POSITION_L4_DEGREES = 64.0, 
      ARM_POSITION_DEEP_CLIMB_DEGREES = 290.5, // 141.5 + 29;
  ...
  public static final double ARM_MOTOR_P = 0.9, // 0.5
      ARM_MOTOR_I = 0.45, // 0.25 // 0.001
