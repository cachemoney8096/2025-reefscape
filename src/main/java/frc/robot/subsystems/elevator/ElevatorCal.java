...
public class ElevatorCal {
  ...
  public static final double POSITION_INTAKE_INCHES = 7.0, // 22.00,
      POSITION_HOME_INCHES = 6.0,
      POSITION_SCORE_L4_INCHES = 6.0,
      POSITION_SCORE_L3_INCHES = 21.8, // 21.75
      POSITION_SCORE_L2_INCHES = 9.0, // 10.0,
      POSITION_SCORE_L1_INCHES = 8.0,
      POSITION_ARM_CLEAR_OF_CLIMB_INCHES = 10.0,
  ...
  public static final double MAX_VELOCITY_IN_PER_SECOND_SCORE = 2.0,
