...
public class AlignCommandScoringSide extends Command {
  private final CommandSwerveDrivetrain m_drivetrain;
  private final ScoringLimelight m_Limelight;

  // TODO DO NOT ACTUALLY USE THESE VALUES!!!!
  private static PIDControllerConfigurable rotationalPidController = new PIDControllerConfigurable(0.05000, 0.000000, 0.001000, 0.01);
  ...
  public AlignCommandScoringSide(CommandSwerveDrivetrain drivetrain, ScoringLimelight limelight) {
  ...
  public AlignCommandScoringSide(CommandSwerveDrivetrain drivetrain, ScoringLimelight limelight, int ID) throws IllegalArgumentException{
    this.m_drivetrain = drivetrain;
    this.m_Limelight = limelight;
  ...
  public void execute() {
    ...
    rotationalPidController = new PIDControllerConfigurable(SmartDashboard.getNumber("Rotate P", 0.0), Constants.PLACEHOLDER_DOUBLE, SmartDashboard.getNumber("Rotate D", 0.0), Constants.PLACEHOLDER_DOUBLE);
    ...
    } catch (ScoringLimelight.NoSuchTargetException nste) {
