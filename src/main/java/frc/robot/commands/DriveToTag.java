    ...
    public DriveToTag(CommandSwerveDrivetrain drive, ScoringLimelight limelight){
        ...
        () -> {
          ...
          if (robotToTagOptional.isPresent()) {
            ...
            rotatedRobotToTag = new Transform2d(new Translation2d(-robotToTag.getTranslation().getX(), -robotToTag.getTranslation().getY()), robotToTag.getRotation());
            return true;
          }
          return false;
        };
