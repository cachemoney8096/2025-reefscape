...
public class PIDToPoint extends SequentialCommandGroup{
    ...
    public PIDToPoint(Consumer<Pair<Double, Double>> velocitySetter, Consumer<Double> headingSetter, double heading, Supplier<Boolean> joystickInput, String llName, CommandSwerveDrivetrain drivetrain, double distanceOffsetMeters, double horizontalOffsetMeters){
        ...
        addCommands(
            ...
            new InstantCommand(()->{
                ...
                final Pose2d tagPoseRobotSpaceWpiConvention = new Pose2d(tagPoseRobotSpace.getZ() - distanceOffsetMeters, tagPoseRobotSpace.getX() + horizontalOffsetMeters, Rotation2d.fromDegrees(tagPoseRobotSpace.getRotation().getY()));
            ...
            new WaitUntilCommand(()->{
                ...
                double xOutput = xController.calculate(currentPose.getX(), targetPoseFieldSpace.getX());
