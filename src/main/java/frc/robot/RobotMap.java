...
public class RobotMap {
  ...
  public static final int LEFT_ARM_MOTOR_CAN_ID = 7, RIGHT_ARM_MOTOR_CAN_ID = 17;
  ...
  public static final int CLIMBING_LEFT_MOTOR_CAN_ID = 11,
      CLIMBING_RIGHT_MOTOR_CAN_ID = 12,
  ...
  public static final int CANDLE_CAN_ID = 5;

  public static final int LEFT_ELEVATOR_MOTOR_CAN_ID = 6, RIGHT_ELEVATOR_MOTOR_CAN_ID = 16;
  ...
  public static final int FRONT_LEFT_DRIVING_CAN_ID = 9,
      ...
      FRONT_RIGHT_TURNING_CAN_ID = 13,
      REAR_LEFT_DRIVING_CAN_ID = 3,
      REAR_LEFT_TURNING_CAN_ID = 2,
      REAR_RIGHT_DRIVING_CAN_ID = 20,
      REAR_RIGHT_TURNING_CAN_ID = 21;
  public static final int FRONT_LEFT_CANCODER_CAN_ID = 10,
      FRONT_RIGHT_CANCODER_CAN_ID = 15,
