...
public class RobotContainer implements Sendable {
    ...
    private double MaxAngularRate = Units.RotationsPerSecond.of(0.75).in(Units.RadiansPerSecond); // 3/4 of a rotation per second
    ...
    public RobotContainer(MatchStateUtil ms) {
        ...
        autonChooser.addOption(
                ...
                new Pair<Command, String>(
                        new P2_S1_I_J(
                                drivetrain, arm, claw, elevator, intakeLimelight, scoringLimelight, matchState.isRed()),
                        null));
        ...
        driverController
                ...
                .whileTrue(
                        new SequentialCommandGroup(
                                new IntakeSequence(
                                        claw, intakeLimelight, arm, elevator, climb, preppedLocation, drivetrain, lights),
